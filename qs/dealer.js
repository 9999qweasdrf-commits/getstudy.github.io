document.addEventListener("DOMContentLoaded", e => {
    ...
    */
    ...
    rootDomDealer.CCE("#block|#rightblock", "div", { id: "rightcontent", styles: {"margin-top": "40px", "margin-bottom": "80px", "margin-right": "20px", "margin-left": "20px" , border : "solid 5px grey", "border-radius": "15px"}})
